...
Scenario: The Science Museum Keyword Search
	...
	And I Hit The Search Button
	Then I Should See Search Results for 'Science Museum' Containing The Keyword 'Natural History Museum'
...
Scenario: The Premier Inn Keyword Search
	...
	And I Hit The Search Button
	Then I Should See Search Results for 'Premier Inn' Containing The Keyword 'Natural History Museum'
...
Scenario: The Holiday Inn Keyword Search
	...
	And I Hit The Search Button
	Then I Should See Search Results for 'Holiday Inn' Containing The Keyword 'Natural History Museum'
...
Scenario: The Harry Potter Keyword Search
	...
	And I Hit The Search Button
	Then I Should See Search Results for 'Harry Potter' Containing The Keyword 'Natural History Museum'